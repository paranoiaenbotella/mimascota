        ...
        <div class="col-sm-12 col-md-12  col-lg-12  shadow-sm p-3 mb-5 rounded">
            ...
            <table class="table table-sm table-hover border border-success">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo $opinion->obtenerId(); ?></td>
                        <td><?php echo $opinion->obtenerUsuario(); ?></td>
                        <td><?php echo $opinion->obtenerAnuncio(); ?></td>
                        ...
                        <td>
                            <a href="/opiniones/eliminar/<?php echo($anuncio->obtenerId(

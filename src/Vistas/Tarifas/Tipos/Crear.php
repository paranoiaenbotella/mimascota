<section class="container">
    <div class="row">
        <div class="col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-4 offset-lg-4">
            <h4>Crear tipos de tarifas</h4>
            <form method="POST">
                <div class="form-group my-0">
                    <label for="nombre" class="mb-0">Tipo de tarifa:</label>
                    <input class="form-control form-control-sm" id="nombre" name="nombre" type="text">
                    <?php if (Sesion::existeError("nombreTipoTarifa")): ?>
                        <div>
                            <p class="error"><?php echo(Sesion::obtenerError("nombreTipoTarifa")); ?></p>
                        </div>
